...
import 'shared/private_util.dart';
...
class TableCalendar<T> extends StatefulWidget {
  ...
  ///
  ///
  /// Georgian calendar format or jalali
  ///
  final bool isJalali;
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  void _onDayTapped(DateTime day, bool isJalali) {
    final isOutside = isDayOutside(day, _focusedDay.value, isJalali);
    ...
    _updateFocusOnTap(day, isJalali);
  ...
  void _onDayLongPressed(DateTime day, bool isJalali) {
    final isOutside = isDayOutside(day, _focusedDay.value, isJalali);
  ...
  void _updateFocusOnTap(DateTime day, bool isJalali) {
    ...
    if (widget.calendarFormat == CalendarFormat.month) {
      if (_isBeforeMonth(day, _focusedDay.value)) {
        _focusedDay.value = PrivateUtils.firstDayOfMonth(_focusedDay.value, isJalali);
      } else if (_isAfterMonth(day, _focusedDay.value)) {
        _focusedDay.value = PrivateUtils.lastDayOfMonth(_focusedDay.value, isJalali);
      } else {
        _focusedDay.value = day;
      }
    } else {
          ...
          child: TableCalendarBase(
            ...
            dayBuilder: (context, day, focusedMonth) {
              return GestureDetector(
                ...
                onTap: () => _onDayTapped(day, widget.isJalali),
                onLongPress: () => _onDayLongPressed(day, widget.isJalali),
                child: _buildCell(day, focusedMonth, widget.isJalali),
              );
            },
          ),
        ),
  ...
  isDayOutside(DateTime day, DateTime focusedDay, bool isJalali) {
    if (isJalali) {
      return day.toJalali().month != focusedDay.toJalali().month;
    } else {
      return day.month != focusedDay.month;
    }
  }

  Widget _buildCell(DateTime day, DateTime focusedDay, bool isJalali) {
    final isOutside = isDayOutside(day, focusedDay, isJalali);
