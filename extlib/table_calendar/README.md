...
It is worth noting that you don't need to call `setState()` inside `onPageChanged()` callback. You
...
To display the calendar in desired language, use `locale` property. If you don't specify it, a
